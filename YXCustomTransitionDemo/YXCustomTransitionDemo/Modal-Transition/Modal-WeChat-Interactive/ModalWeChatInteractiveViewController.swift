//
//  ModalWeChatInteractiveViewController.swift
...
class ModalWeChatInteractiveViewController: UIViewController {
    ...
    @objc func pushSecond() {
        ...
        let controller = ModalWeChatInteractiveSecondViewController()
