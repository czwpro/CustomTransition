//
//  YXModalWeChatViewController.swift
...
class YXModalWeChatViewController: UIViewController {

    var animatedTransition = YXModalWeChatAnimationTransition()
    ...
    @objc func pushSecond() {
        ...
        let controller = YXModalWeChatSecondViewController()
        // 2.设置代理
