//
//  ModalWeChatInteractiveAnimatedTransition.swift
...
class ModalWeChatInteractiveAnimatedTransition: NSObject {

    private let customPush = NavWeChatInteractivePushAnimator()
    private let customPop = NavWeChatInteractivePopAnimator()
    
    private lazy var percentIntractive = ModalWeChatPercentDrivenInteractive(gestureRecognizer: self.gestureRecognizer)
...
extension ModalWeChatInteractiveAnimatedTransition: UIViewControllerTransitioningDelegate {
