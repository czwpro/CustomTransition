//
//  YXModalKuGouInteractiveViewController.swift
...
class YXModalKuGouInteractiveViewController: UIViewController {

   
    lazy var animatedTransition = YXModalKuGouInteractiveAnimatedTransition()
