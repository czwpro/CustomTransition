//
//  QuestionsOneFirstViewController.swift
...
class QuestionsOneFirstViewController: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(QuestionOneCell.self, forCellReuseIdentifier: "cellID")
        return tableView
    }()
    ...
    private let animatedTransition = QuestionsOneAnimationTrasition()
...
extension QuestionsOneFirstViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellID") as! QuestionOneCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //2. 传入必要的3个参数
        let cell = tableView.cellForRow(at: indexPath) as! QuestionOneCell
        ...
        // 3.push跳转
        let controller = QuestionsOneSecondViewController()
