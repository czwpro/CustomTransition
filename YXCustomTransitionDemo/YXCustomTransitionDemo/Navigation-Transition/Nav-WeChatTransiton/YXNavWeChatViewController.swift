//
//  YXNavWeChatViewController.swift
...
class YXNavWeChatViewController: UIViewController {

    var animatedTransition = YXNavWeChatAnimationTransition()
    ...
    @objc func pushSecond() {
        ...
        let controller = YXNavWeChatSecondViewController()
