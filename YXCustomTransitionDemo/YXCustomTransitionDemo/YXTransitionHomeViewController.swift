//
//  YXTransitionHomeViewController.swift
...
class YXTransitionHomeViewController: UIViewController {
    ...
    let controllerArray = [
        ...
        ["YXNavCATransitionFirstViewController",
         "YXModalCATransitionFirstViewController"
        ],
    
        ["YXNavBaseFirstViewController",
         "YXNavKuGouTransitionViewController",
         "YXNavWeChatViewController",
         "YXNavBaseInteractiveFirstViewController",
         "YXNavKuGouInteractiveViewController",
         "YXNavWeChatInteractiveViewController"
        ],
    
        ["YXModalBaseViewController",
         "YXModalKuGouViewController",
         "YXModalWeChatViewController",
         "YXModalKuGouInteractiveViewController",
         "YXModalWeChatInteractiveViewController"
        ],
    
        ["YXQuestionsOneFirstViewController",
         "YXQuestionTwoFirstViewController"
        ],
    
        ["YXPictureFirstViewController"]
    ]
...
extension YXTransitionHomeViewController: UITableViewDataSource, UITableViewDelegate {
