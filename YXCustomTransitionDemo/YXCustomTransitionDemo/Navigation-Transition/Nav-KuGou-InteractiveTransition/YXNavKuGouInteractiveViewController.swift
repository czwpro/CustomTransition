//
//  YXNavKuGouInteractiveViewController.swift
...
class YXNavKuGouInteractiveViewController: UIViewController {

    private let animatedTransition = YXNavKuGouInteractiveAnimatedTransition()
    ...
    @objc func pushSecond() {
        ...
        // 2.push跳转
        let controller = YXNavKuGouInteractiveSecondViewController()
