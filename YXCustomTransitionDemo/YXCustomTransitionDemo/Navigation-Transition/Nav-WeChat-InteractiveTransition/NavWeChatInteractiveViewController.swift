//
//  NavWeChatInteractiveViewController.swift
...
class NavWeChatInteractiveViewController: UIViewController {
    ...
    @objc func pushSecond() {
        ...
        // 3.push跳转
        let controller = NavWeChatInteractiveSecondViewController()
