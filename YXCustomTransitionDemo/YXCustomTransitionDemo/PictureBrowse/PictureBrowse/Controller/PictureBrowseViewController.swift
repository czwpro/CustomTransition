...
class PictureBrowseViewController: UIViewController {

    private var transitionImgViewCenter = CGPoint.zero
    
    var animatedTransition: PictureBrowseInteractiveAnimatedTransition?
    var dataSouceArray = [PictureBrowseSouceModel]()
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        let collectionView = UICollectionView(frame: CGRect(x: 0, y: 0, width: _screenWidth + kBrowseSpace, height: _screenHeight), collectionViewLayout: flowLayout)
        ...
        collectionView.register(PictureBrowserCell.self, forCellWithReuseIdentifier: "\(PictureBrowserCell.self)")
    ...
    func setupBaseViewControllerProperty(cellIndex: Int) {
        let cell = collectionView.cellForItem(at: IndexPath(row: cellIndex, section: 0)) as! PictureBrowserCell
...
extension PictureBrowseViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "\(PictureBrowserCell.self)", for: indexPath) as! PictureBrowserCell
...
// Scrollview Delegate
extension PictureBrowseViewController {
    
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        let offset = collectionView.contentOffset.x
        let cellIndex = offset / (_screenWidth + kBrowseSpace)
        setupBaseViewControllerProperty(cellIndex: Int(cellIndex))
    }
}


extension PictureBrowseViewController: PictureBrowserCellDelegate {
