//
//  NavKuGouInteractiveSecondViewController.swift
...
class NavKuGouInteractiveSecondViewController: UIViewController {

   
    let animatedTransition = NavKuGouInteractiveAnimatedTransition()
