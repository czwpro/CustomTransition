//
//  QuestionTwoFirstViewController.swift
...
class QuestionTwoFirstViewController: UIViewController {
    ...
    private let animatedTransition = QuestionTwoAnimationTransition()
    ...
    @objc func pushSecond() {
        ...
        //3.push跳转
        let secondController = QuestionTwoSecondViewController()
