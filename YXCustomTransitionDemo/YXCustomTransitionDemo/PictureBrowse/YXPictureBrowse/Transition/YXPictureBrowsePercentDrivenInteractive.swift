//
//  YXPictureBrowsePercentDrivenInteractive.swift
...
class YXPictureBrowsePercentDrivenInteractive: UIPercentDrivenInteractiveTransition {

    private let transitionParameter: YXPictureBrowseTransitionParameter
    ...
    init(transitionParameter: YXPictureBrowseTransitionParameter) {
