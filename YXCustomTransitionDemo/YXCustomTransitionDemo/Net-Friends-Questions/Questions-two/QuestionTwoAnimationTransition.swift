//
//  QuestionTwoAnimationTransition.swift
...
class QuestionTwoAnimationTransition: NSObject, UINavigationControllerDelegate {
    ...
    private let customPush = QuestionTwoPushAnimator()
    private let customPop = QuestionTwoPopAnimator()
