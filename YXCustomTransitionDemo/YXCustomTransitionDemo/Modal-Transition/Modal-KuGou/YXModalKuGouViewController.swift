//
//  YXModalKuGouViewController.swift
...
class YXModalKuGouViewController: UIViewController {

    lazy var animatedTransition = YXModalKuGouAnimationTransition()
    ...
    @objc func presentSecond() {
        let controller = YXModalKuGouSecondViewController()
